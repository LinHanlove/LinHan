...
const base = 'https://linhan.atomnotion.com/'
const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @LinHan7\'s ${base}${route.path}\n\nI think...`)}`)
const elkUrl = computed(() => `https://elk.zone/intent/post?text=${encodeURIComponent(`Reading @LinHan@m.webtoo.ls\'s ${base}${route.path}\n\nI think...`)}`)
