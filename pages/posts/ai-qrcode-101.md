...
<p>
<span i-carbon-events mr1 /> Co-authored by <a href="https://antfu.me" target="_blank">LinHan</a>, <a href="https://space.bilibili.com/339984/" target="_blank">赛博迪克朗</a>, wangcai and <a href="https://www.xiaohongshu.com/user/profile/5be8fb806b58b745447aab0f" target="_blank">代々木</a>
</p>
...
- [Stylistic QR Code with Stable Diffusion](/posts/ai-qrcode) - by LinHan
- [Refining AI Generated QR Code](/posts/ai-qrcode-refine) - by LinHan
...
<div py15>
  <div grid="~ md:cols-3 cols-2 gap-x-2 gap-y-4" lg:scale-110 md:scale-105>
    ...
    <figure important-my-0>
      ...
      <figcaption text-center>
        <b text-lg>plants</b>
        <div text-xs mt1>by <a href="https://antfu.me" target="_blank">LinHan</a></div>
      </figcaption>
    </figure>
    <figure important-my-0>
...
<figure>
  ...
  <figcaption text-center>
    by <a href="https://antfu.me/" target="_blank">LinHan</a>
  </figcaption>
</figure>
...
<div border="~ rounded-full base" px3 py1 inline text-sm float-right>
<span i-ri-book-2-line /> Credits to <a href="https://antfu.me" target="_blank">LinHan</a>
</div>
...
If you are interested in contributing to this post, fixing typos, or adding new ideas, you can [edit this page on GitHub](https://github.com/LinHanlove/antfu.me/edit/main/pages/posts/ai-qrcode-101.md). Or if you are not familiar with Git, you can also go to [Anthony's Discord server](https://chat.antfu.me) and discuss with us.
